...
```powershell
uv run pic provenance create --schema-dir schemas --sbom-ref dist\percolation-inversion-compiler-0.4.0.sbom.json --artifact-ref dist\percolation_inversion_compiler-0.4.0-py3-none-any.whl --artifact-ref dist\percolation_inversion_compiler-0.4.0.tar.gz --output provenance.json
```
...
```powershell
uv run pic sbom create --format pic --output dist\percolation-inversion-compiler-0.4.0.sbom.json
uv run pic sbom create --format cyclonedx --output dist\percolation-inversion-compiler-0.4.0.cyclonedx.json
```
