...
REQUIRED_WHEEL_MEMBERS = {
    ...
    "percolation_inversion_compiler/data/demo/afst/balance_witness.json",
    "percolation_inversion_compiler/data/demo/afst/blocked_authority.json",
    "percolation_inversion_compiler/data/demo/afst/blocked_balance.json",
    "percolation_inversion_compiler/data/demo/afst/blocked_buffer.json",
    "percolation_inversion_compiler/data/demo/afst/blocked_missing_shock.json",
    "percolation_inversion_compiler/data/demo/afst/blocked_refusal.json",
    "percolation_inversion_compiler/data/demo/afst/blocked_unit_mismatch.json",
    "percolation_inversion_compiler/data/demo/afst/handover_minimal.json",
    "percolation_inversion_compiler/data/demo/afst/minimal_accepted.json",
    ...
    "percolation_inversion_compiler/data/docs/afst.md",
...
REQUIRED_SDIST_SUFFIXES = {
    ...
    "src/percolation_inversion_compiler/data/demo/afst/balance_witness.json",
    "src/percolation_inversion_compiler/data/demo/afst/blocked_authority.json",
    "src/percolation_inversion_compiler/data/demo/afst/blocked_balance.json",
    "src/percolation_inversion_compiler/data/demo/afst/blocked_buffer.json",
    "src/percolation_inversion_compiler/data/demo/afst/blocked_missing_shock.json",
    "src/percolation_inversion_compiler/data/demo/afst/blocked_refusal.json",
    "src/percolation_inversion_compiler/data/demo/afst/blocked_unit_mismatch.json",
    "src/percolation_inversion_compiler/data/demo/afst/handover_minimal.json",
    "src/percolation_inversion_compiler/data/demo/afst/minimal_accepted.json",
    ...
    "examples/afst/minimal_accepted.json",
