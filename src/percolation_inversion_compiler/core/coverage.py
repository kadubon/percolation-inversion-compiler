...
_IMPLEMENTED: dict[str, tuple[CoverageStatus, str]] = {
    ...
    "abstraction token": (CoverageStatus.IMPLEMENTED_SCHEMA, "alt.AbstractionToken"),
    "operational token": (CoverageStatus.IMPLEMENTED_CHECKER, "alt.check_token_admissibility"),
    "token admissibility": (CoverageStatus.IMPLEMENTED_CHECKER, "alt.check_token_admissibility"),
    "problem-solving trace": (CoverageStatus.IMPLEMENTED_SCHEMA, "alt.ProblemSolvingTrace"),
    "observed trace projection": (
        CoverageStatus.IMPLEMENTED_SCHEMA,
        "alt.ObservedTraceProjection",
    ),
    "trace sufficiency": (
        CoverageStatus.IMPLEMENTED_CHECKER,
        "alt.TraceSufficiencyCertificate",
    ),
    "formation-cost ledger": (CoverageStatus.IMPLEMENTED_SCHEMA, "alt.FormationCostLedger"),
    "lifecycle cost": (CoverageStatus.IMPLEMENTED_SCHEMA, "alt.LifecycleCostBounds"),
    "mission validity": (CoverageStatus.IMPLEMENTED_CHECKER, "alt.MissionValidityCertificate"),
    "transport certificate": (
        CoverageStatus.IMPLEMENTED_CHECKER,
        "alt.check_transport_certificate",
    ),
    "liquidity certificate": (
        CoverageStatus.IMPLEMENTED_CHECKER,
        "alt.check_liquidity_certificate",
    ),
    "signed certificate discipline": (
        CoverageStatus.IMPLEMENTED_CHECKER,
        "alt.check_liquidity_certificate",
    ),
    "signed surplus": (
        CoverageStatus.IMPLEMENTED_CONSTRUCTIVE,
        "alt.certified_surplus_lower_bound",
    ),
    "executable alt certificate packet": (
        CoverageStatus.IMPLEMENTED_SCHEMA,
        "alt.ExecutableALTCertificatePacket",
    ),
    "foundry state": (CoverageStatus.IMPLEMENTED_SCHEMA, "alt.FoundryState"),
    "foundry control dashboard": (
        CoverageStatus.IMPLEMENTED_CHECKER,
        "alt.compute_foundry_dashboard",
    ),
    "foundry phase-control": (
        CoverageStatus.IMPLEMENTED_CHECKER,
        "alt.predict_foundry_phase_control",
    ),
    "certified abstraction liquidity capital": (
        CoverageStatus.IMPLEMENTED_SCHEMA,
        "alt.CertifiedAbstractionCapital",
    ),
    "certified abstraction capital": (
        CoverageStatus.IMPLEMENTED_SCHEMA,
        "alt.CertifiedAbstractionCapital",
    ),
    "target-valid alt-cara": (CoverageStatus.IMPLEMENTED_SCHEMA, "alt.ALTCARACertificate"),
    "certified asi realization acceleration": (
        CoverageStatus.IMPLEMENTED_SCHEMA,
        "alt.ALTAccelerationCertificate",
    ),
...
_EXTERNAL_ROUTE_RULES: list[
    ...
    (
        "alt-transport",
        ("density-ratio", "support coverage", "transport certificate", "adapter graph"),
        "alt.adapters.transport.verify_density_ratio_support",
        ("transport-certificate", "support-coverage-witness", "density-ratio-bound"),
        "charge-alt-transport-residual-until-support-and-density-accepted",
        "diagnostic-with-alt-transport-obligation",
        (
            "support-coverage-witness-missing",
            "density-ratio-bound-unverified",
            "transport-domain-shift-unresolved",
        ),
    ),
    (
        "alt-causal-effect",
        ("counterfactual effect", "mechanism-ablation", "causal reproduction", "token effect"),
        "alt.adapters.causal.verify_token_effect",
        ("counterfactual-report", "mechanism-ablation-contrast", "causal-effect-witness"),
        "charge-alt-causal-residual-until-token-effect-certified",
        "diagnostic-with-alt-causal-obligation",
        (
            "counterfactual-report-missing",
            "mechanism-ablation-unverified",
            "causal-effect-witness-missing",
        ),
    ),
    (
        "alt-root-trust",
        ("root-of-trust", "evaluator quorum", "role-separated", "evaluator capture"),
        "alt.adapters.root.verify_role_separated_quorum",
        ("root-of-trust-packet", "role-separation-ledger", "quorum-signature-report"),
        "charge-alt-root-residual-until-quorum-accepted",
        "diagnostic-with-alt-root-obligation",
        (
            "root-of-trust-packet-missing",
            "role-separation-not-certified",
            "evaluator-capture-not-excluded",
        ),
    ),
    (
        "alt-telemetry",
        ("telemetry observer", "telemetry-corrected", "hidden-resource", "instrumentation"),
        "alt.adapters.telemetry.verify_cost_instrumentation",
        ("telemetry-ledger", "instrumentation-contract", "hidden-resource-audit"),
        "charge-alt-telemetry-residual-until-instrumentation-accepted",
        "diagnostic-with-alt-telemetry-obligation",
        (
            "telemetry-ledger-missing",
            "instrumentation-contract-unverified",
            "hidden-resource-audit-missing",
        ),
    ),
    (
        "alt-hazard",
        ("adversarial token", "contamination", "misapplication", "hazard envelope"),
        "alt.adapters.hazard.verify_adversarial_token_clearance",
        ("hazard-envelope", "misapplication-audit", "contamination-bound"),
        "charge-alt-hazard-residual-until-token-clearance-accepted",
        "diagnostic-with-alt-hazard-obligation",
        (
            "hazard-envelope-missing",
            "misapplication-audit-unverified",
            "contamination-bound-missing",
        ),
    ),
    (
        "alt-reproduction",
        ("reproduction matrix", "capital reproduction", "multitype abstraction", "recombination"),
        "alt.adapters.reproduction.verify_capital_reproduction_matrix",
        ("reproduction-matrix-certificate", "recombination-witness", "capacity-bound"),
        "charge-alt-reproduction-residual-until-matrix-certified",
        "diagnostic-with-alt-reproduction-obligation",
        (
            "reproduction-matrix-certificate-missing",
            "recombination-witness-unverified",
            "capacity-bound-not-certified",
        ),
    ),
    (
        "alt-cara-target",
        ("alt-cara", "asi realization acceleration", "declared asi target", "target validity"),
        "alt.adapters.target.verify_alt_cara_target",
        ("target-validity-certificate", "baseline-upper-envelope", "resource-matched-report"),
        "charge-alt-cara-residual-until-target-contract-accepted",
        "diagnostic-with-alt-cara-obligation",
        (
            "target-validity-certificate-missing",
            "baseline-upper-envelope-unverified",
            "resource-matched-report-missing",
        ),
    ),
    (
