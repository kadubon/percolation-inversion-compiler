...
def test_release_version_metadata_is_consistent() -> None:
    ...
    assert citation["date-released"] == "2026-06-22"
    ...
    assert changelog.index("## v0.5.0 - 2026-06-22") < changelog.index("## v0.4.4")
...
def test_release_checklist_warns_against_local_dist_star_publish() -> None:
    ...
    assert "dist\\percolation_inversion_compiler-0.5.0-py3-none-any.whl" in text
    assert "dist\\percolation_inversion_compiler-0.5.0.tar.gz" in text
